...
#for f_idx in reversed(range(20, 22)):
    ...
    for (root, subdirs, files) in os.walk(photo_path_aoi):
        ...
        dataset = {'predict' : ImageFolderEX(photo_path_aoi, centre_crop)} # what's the difference??
        ...
        # Instead, pass collate_fn() to the DataLoader()
